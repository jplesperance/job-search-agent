...
def _summary(policy: TargetingPolicy) -> PolicySummary:
    return PolicySummary(
        ...
        remote_minimum_base_salary_usd=(float(policy.remote_minimum_base_salary_usd) if policy.remote_minimum_base_salary_usd is not None else None),
...
def create_policy(
    ...
    policy = TargetingPolicy(
        ...
        remote_minimum_base_salary_usd=(Decimal(str(request.remote_minimum_base_salary_usd)) if request.remote_minimum_base_salary_usd is not None else None),
