...
from job_agent.domain.discovery import DiscoveryCandidateSummary, DiscoveryRunStatus, DiscoveryRunSummary, DiscoverySourceCreate, DiscoverySourceSummary
...
class DiscoveryRepository(Protocol):
    ...
    def list_candidates(self, *, minimum_score: float = 80.0, limit: int = 100, open_only: bool = True) -> list[DiscoveryCandidateSummary]: ...
